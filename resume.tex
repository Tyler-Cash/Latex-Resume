...
\address{0411~$\cdot$~319~$\cdot$~513 \\ tyler@tylercash.dev \\ \href{https://github.com/Tyler-Cash}{\color{blue}{Github}}} % Your phone number and email
...
\begin{rSection}{Experience}
    ...
    \item Develop big data ingestion solutions using Spark that are exposed with Hive tables
    \item Create frameworks to be used by our end users (e.g. Job scheduler, RLS, automation tooling)
    \item L2-L3 support of Spark, Oozie and Hive services
    \item Introduced automation tools across manual processes to reduce manual effort.
    \end{rSubsection}
